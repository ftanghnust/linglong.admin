<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_agent_list.aspx.cs" Inherits="LingLong.Admin.Web.admin.sys_user.sys_agent_list" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="sys_agent_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
