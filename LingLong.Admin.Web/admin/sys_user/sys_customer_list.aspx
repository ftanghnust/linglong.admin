<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_customer_list.aspx.cs" Inherits="LingLong.Admin.Web.admin.sys_user.sys_customer_list" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" href="sys_customer_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
                    ...
                    <div class="r-list">
                        <table>
                            <tr>
                                ...
                                <td><span>昵称</span></td>
                                <td>
                                    <asp:TextBox ID="txtNickname" runat="server" CssClass="keyword" /></td>
                                <td>
            ...
            <asp:Repeater ID="rptList" runat="server">
                <HeaderTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                        <tr>
                            ...
                            <th align="center" width="5%">客户类型</th>--%>
                            <%--<th width="5%">是否管理员</th>--%>
                            ...
                            <th align="center" width="8%">开屏密码</th>
                            <%--  <th align="center" width="5%">身高</th>
                            <th align="center" width="8%">生日</th>--%>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><%# Eval("CustomerType").ToString() == "0"?"自动":"手动添加" %></td>--%>
                        ...
                        <td align="center"><%# Eval("PassWord").ToString() %></td>
                        ...
                        <td align="center"><a href="sys_customer_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
