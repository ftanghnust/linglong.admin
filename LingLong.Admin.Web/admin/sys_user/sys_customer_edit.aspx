<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_customer_edit.aspx.cs" Inherits="LingLong.Admin.Web.admin.sys_user.sys_customer_edit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="sys_customer_list.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="sys_customer_list.aspx"><span>客户管理</span></a>
            <i class="arrow"></i>
            <span>编辑客户</span>
        </div>
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">编辑客户</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    <div class="rule-single-select">
                        <asp:DropDownList ID="ddl_CustomerType" runat="server" datatype="*" CssClass="select" sucmsg=" ">
                            <asp:ListItem Value="0" Text="自动"></asp:ListItem>
                            <asp:ListItem Value="1" Text="服务员手动添加"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </dd>
            </dl>
            ...
            <dl>
                <dt>微信号</dt>
                <dd>
                    <asp:TextBox ID="txt_Wechat" runat="server" CssClass="input normal" Enabled="false"></asp:TextBox>
            </dl>
            <dl>
                <dt>昵称</dt>
                <dd>
