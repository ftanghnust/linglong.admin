...
{
    public partial class sys_rewardmoney_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("sys_rewarddistribution", DTEnums.ActionEnum.View.ToString()); //检查权限
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("sys_rewarddistribution_list.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            ChkAdminLevel("sys_rewarddistribution", DTEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.t_reward_distribution bll = new BLL.t_reward_distribution();
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("reward_distribution_list.aspx", "keywords={0}", this.keywords));
        }
    }
}