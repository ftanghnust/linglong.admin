...
{
	/// <summary>
	/// t_store:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class t_store
	{
		...
		#region Model
		private int _id;
		private string _applyopenid;
		private string _storename;
		private string _phonenumber;
		private string _storeimgurl;
		...
		/// 
		/// </summary>
		public string ApplyOpenId
		{
			set{ _applyopenid=value;}
			get{return _applyopenid;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		{
			set{ _storeimgurl=value;}
			get{return _storeimgurl;}
		}
		/// <summary>
		/// 
		/// </summary>
