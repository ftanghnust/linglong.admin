...
{
	/// <summary>
	/// 数据访问类:t_store_comment
	/// </summary>
	public partial class t_store_comment
	{
        private string databaseprefix;
        public t_store_comment(string _databaseprefix)
		...
		public int GetMaxId()
		{
		return DbHelperMySql.GetMaxID("ID", "t_store_comment"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from t_store_comment");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(LingLong.Admin.Model.t_store_comment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into t_store_comment(");
			strSql.Append("StoreId,CustomerId,Score,CommentTime,IsDeleted,DeleterUserId,LastModificationTime,LastModifierUserId,CreationTime,CreatorUserId)");
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@CommentTime", MySqlDbType.DateTime),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(LingLong.Admin.Model.t_store_comment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update t_store_comment set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_store_comment ");
			strSql.Append(" where ID=@ID");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public LingLong.Admin.Model.t_store_comment GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,StoreId,CustomerId,Score,CommentTime,IsDeleted,DeleterUserId,LastModificationTime,LastModifierUserId,CreationTime,CreatorUserId from t_store_comment ");
			strSql.Append(" where ID=@ID");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32)
			};
			...
			LingLong.Admin.Model.t_store_comment model=new LingLong.Admin.Model.t_store_comment();
		...
		/// 得到一个对象实体
		/// </summary>
		public LingLong.Admin.Model.t_store_comment DataRowToModel(DataRow row)
		{
			LingLong.Admin.Model.t_store_comment model=new LingLong.Admin.Model.t_store_comment();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,StoreId,CustomerId,Score,CommentTime,IsDeleted,DeleterUserId,LastModificationTime,LastModifierUserId,CreationTime,CreatorUserId ");
			strSql.Append(" FROM t_store_comment ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from t_store_comment T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "t_store_comment";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM t_store_comment");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
