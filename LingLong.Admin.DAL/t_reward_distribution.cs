...
{
	/// <summary>
	/// 数据访问类:t_reward_distribution
	/// </summary>
	public partial class t_reward_distribution
	{
        private string databaseprefix; //数据库表名前缀
        public t_reward_distribution(string _databaseprefix)
		...
		public int GetMaxId()
		{
		return DbHelperMySql.GetMaxID("ID", "t_reward_distribution"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from t_reward_distribution");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_reward_distribution ");
			strSql.Append(" where ID=@ID");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,DistributionName,PlatformRatio,AgentRatio,StoreRatio,BusinessRatio,IsDefault,IsUse,IsDeleted,DeleterUserId,LastModificationTime,LastModifierUserId,CreationTime,CreatorUserId ");
			strSql.Append(" FROM t_reward_distribution ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from t_reward_distribution T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "t_reward_distribution";
