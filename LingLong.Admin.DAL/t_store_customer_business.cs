...
{
	/// <summary>
	/// 数据访问类:t_store_customer_business
	/// </summary>
	public partial class t_store_customer_business
	{
        private string databaseprefix;
        public t_store_customer_business(string _databaseprefix)
		...
		public int GetMaxId()
		{
		return DbHelperMySql.GetMaxID("ID", "t_store_customer_business"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from t_store_customer_business");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_store_customer_business ");
			strSql.Append(" where ID=@ID");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,StoreId,CustomerId,BusinessId ");
			strSql.Append(" FROM t_store_customer_business ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from t_store_customer_business T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "t_store_customer_business";
