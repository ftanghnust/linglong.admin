...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2018/9/5 22:59:59   N/A    初版
*
...
namespace LingLong.Admin.DAL
{
	...
	public partial class t_reward_plan
	{
        ...
        public t_reward_plan(string _databaseprefix)
		...
		public int GetMaxId()
		{
		return DbHelperMySql.GetMaxID("ID", "t_reward_plan"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from t_reward_plan");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(LingLong.Admin.Model.t_reward_plan model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into t_reward_plan(");
			strSql.Append("PlanName,IsDefault,IsUse,IsDeleted,DeleterUserId,LastModificationTime,LastModifierUserId,CreationTime,CreatorUserId)");
			strSql.Append(" values (");
			strSql.Append("@PlanName,@IsDefault,@IsUse,@IsDeleted,@DeleterUserId,@LastModificationTime,@LastModifierUserId,@CreationTime,@CreatorUserId)");
			MySqlParameter[] parameters = {
					new MySqlParameter("@PlanName", MySqlDbType.VarChar,50),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(LingLong.Admin.Model.t_reward_plan model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update t_reward_plan set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_reward_plan ");
			strSql.Append(" where ID=@ID");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public LingLong.Admin.Model.t_reward_plan GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,PlanName,IsDefault,IsUse,IsDeleted,DeleterUserId,LastModificationTime,LastModifierUserId,CreationTime,CreatorUserId from t_reward_plan ");
			strSql.Append(" where ID=@ID");
			MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32)
			};
			...
			LingLong.Admin.Model.t_reward_plan model=new LingLong.Admin.Model.t_reward_plan();
		...
		/// 得到一个对象实体
		/// </summary>
		public LingLong.Admin.Model.t_reward_plan DataRowToModel(DataRow row)
		{
			LingLong.Admin.Model.t_reward_plan model=new LingLong.Admin.Model.t_reward_plan();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,PlanName,IsDefault,IsUse,IsDeleted,DeleterUserId,LastModificationTime,LastModifierUserId,CreationTime,CreatorUserId ");
			strSql.Append(" FROM t_reward_plan ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from t_reward_plan T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "t_reward_plan";
